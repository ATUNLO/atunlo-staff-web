...
function PaymentsAdmin() {
  ...
  const handleSearchClick = () => {
    if (reference.trim()) {
      getTransactions(reference.trim());
    }
  };
  ...
  return (
    <div className="px-[30px] py-[40px] max-w-full">
      <div className="flex flex-col">
        <h1 className="text-[20px] font-medium mb-[30px]">Transactions</h1>
        <div className="max-w-[100%] h-auto border-solid border-[1px] border-[#E9E9E9] rounded-[10px] py-[55px] mb-[30px]">
          <div className="flex flex-col lg:flex-row  justify-start mb-5 gap-3 pl-5">
            <div className="flex items-center justify-start gap-3 w-[235px] h-[36px] rounded-[10px] border-solid border-[1px] pl-1 border-[#E9E9E9]">
              ...
              <button
                ...
                className="px-3 py-1 bg-[#50c100] text-white text-sm rounded-lg hover:bg-blue-700"
              >
                Search
              </button>
            </div>
              ...
              <tbody>
                {transactions?.map((payment, index) => (
                  <tr key={index}>
                    ...
                    <td className="whitespace-nowrap">
                      {moneyFormat(payment.openingBalance)}
                    </td>
                    <td className="whitespace-nowrap">
                      {moneyFormat(payment.closingBalance)}
                    </td>
                    <td className="whitespace-nowrap">
                    ...
                    <td className="whitespace-nowrap">
                      {moneyFormat(payment.transactionAmount) || "N/A"}
                    </td>
                    <td className="whitespace-nowrap">
