...
import { FormGroup, Input, Label, Pagination, PaginationItem, PaginationLink, Table } from "reactstrap";
        ...
        {retailSection === 'history' && 
          ...
          <div className="overflow-scroll">
            <Table striped>
              <thead>
                <tr>
                  <th className="!text-[#8F8F8F] font-normal">Collection ID</th>
                  <th className="!text-[#8F8F8F] font-normal">Material Name</th>
                  <th className="!text-[#8F8F8F] font-normal">Amount</th>
                  <th className="!text-[#8F8F8F] font-normal">Total Amount Disbursed</th>
                  <th className="!text-[#8F8F8F] font-normal">Total Collected Material</th>
                </tr>
              </thead>
              <tbody>
